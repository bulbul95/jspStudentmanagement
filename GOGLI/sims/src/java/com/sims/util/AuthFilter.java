...
public class AuthFilter implements Filter {
  ...
  public void doFilter(ServletRequest request, ServletResponse response,
    ...
    try {
      ...
      if (reqURI.indexOf("/index.xhtml") >= 0 || reqURI.indexOf("/login.xhtml") >= 0 
              || (ses != null && ses.getAttribute("username") != null && ses.getAttribute("roleName").equals("staff") && reqURI.indexOf("/staff/") >= 0)
